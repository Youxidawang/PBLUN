...
class MatchingLayer(nn.Module):
    ...
    def input_encoding(self, batch_size, pairs, maxlen, table):
    ...
    def forward(self, outputs, Table, pairs_true):
        table = Table.clone()
        ...
        pred_input = self.input_encoding(batch_size, all_pred, pred_maxlen, table)
